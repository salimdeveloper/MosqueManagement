...
using MosqueManagement.Web.Data;

namespace MosqueManagement.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = @"Server=(localdb)\mssqllocaldb;Database=MosqueManagDb;Trusted_Connection=True;";
